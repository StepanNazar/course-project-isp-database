CREATE VIEW VI_InternetAvailabilityCheck AS
...
CREATE VIEW VI_AverageReviewScoreByType AS
...
CREATE VIEW VI_MonthlyUsageStatistics AS
...
CREATE VIEW VI_MonthlyTariffSubscriptionsHistory AS
SELECT 
...
CREATE VIEW VI_MonthlySalesStatisticsByType AS
SELECT 
...
SELECT * FROM VI_InternetAvailabilityCheck
SELECT * FROM VI_AverageReviewScoreByType
SELECT * FROM VI_MonthlyUsageStatistics
SELECT * FROM VI_MonthlyTariffSubscriptionsHistory
SELECT * FROM VI_MonthlySalesStatisticsByType